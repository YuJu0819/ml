# -*- coding: utf-8 -*-
"""「ML2023Spring - HW1」的副本

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1z5EFmMHhcaWmUBakRXUm6TVKh6uwbXfh
...
data_tr.iloc[:, 34:].describe() 
data_corr = data_tr.iloc[:, 34:].corr()
target_col = data_corr['tested_positive.2']
feature = target_col[abs(target_col) >= 0.8] 
...
def select_feat(train_data, valid_data, test_data, select_all=True):
    ...
    if select_all:
        ...
        # feat_idx = [34, 35,36, 41, 45,46,47,  50, 51,  52, 53, 54,59, 63,64, 65, 68,69,70, 71,72, 77, 81 ,82,83,86,87] # TODO: Select suitable feature columns.
...
def trainer(train_loader, valid_loader, model, config, device):
    ...
    # optimizer = torch.optim.SGD(model.parameters(), lr=config['learning_rate'], momentum=0.75, weight_decay = 1e-4)
...
config = {
    'seed': 10,      # Your seed number, you can pick your lucky number. :)
